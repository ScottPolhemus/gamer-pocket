...
`,Ce=(e="rebeccapurple")=>new Promise(((t,r)=>E(((e="rebeccapurple")=>{const[t,r,n]=_(e);return`\n    <svg width="512" height="512" xmlns="http://www.w3.org/2000/svg">\n      <rect width="100%" height="100%" fill="rgb(${t},${r},${n})"/>\n      <ellipse ry="80" rx="80" cy="108" cx="256" fill="#000"/>\n      <ellipse ry="80" rx="80" cy="256" cx="108" fill="#000"/>\n      <ellipse ry="80" rx="80" cy="256" cx="404" fill="#000"/>\n      <ellipse ry="80" rx="80" cy="404" cx="256" fill="#000"/>\n    </svg>\n  `})(e),((e,n)=>e?r(e):t((e=>{var t;const r=document.createElement("canvas");return r.width=512,r.height=512,null==(t=r.getContext("2d"))||t.drawImage(e,0,0),r.toDataURL()})(n)))))),Pe="(min-width: 850px) and (min-height: 500px)",Se="(min-width: 1020px) and (min-height: 650px)",ze="(min-height: 800px) and (min-width: 650px) and (max-width: 1024px)",Me=w.div`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
